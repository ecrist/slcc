    ...
    <div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Link href="/rates" className="card hover:shadow-xl transition-shadow group">
            <div className="text-swan-green mb-4">
              <svg className="h-9 w-9" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <Link href="/course" className="card hover:shadow-xl transition-shadow group">
            <div className="text-swan-green mb-4">
              <svg className="h-9 w-9" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <Link href="/tournaments" className="card hover:shadow-xl transition-shadow group">
            <div className="text-swan-green mb-4">
              <svg className="h-9 w-9" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
